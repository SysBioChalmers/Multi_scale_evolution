...
# Note: the input data of this script is the swiss homolog pdb files downloaded in 2019-5
# These pdb files were stored in ---- /Users/luho/Documents/pdb file/homolog pdb_2019_5
# If run the script in other computer, please first provide the right input file as stated here.
library(tidyverse)
...
meta_parameter_PDB_homo <- read.table("/Users/luho/Documents/pdb file/homolog pdb_2019_5/INDEX", sep = "\t", header = TRUE, stringsAsFactors = FALSE)
