...
for i in *.pml
do
	python /Users/luho/Desktop/example/code/site_dn_ds/C1_produce_control_file.py -n /Users/luho/Documents/site_data/$i -t /Users/luho/Documents/site_data/${i%.pml}.tree -c /Users/luho/Documents/PAML/site_model/ -o /Users/luho/Documents/paml_result/${i%.pml}.out
