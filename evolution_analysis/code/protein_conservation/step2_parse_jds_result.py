...
def calConservationScore(fasta_file, jsd_file, outfile, output ="median"):
    ...
    if len(index_sce)>=1:
        ...
        conservation_score_jds = open(jsd_file).readlines()
...
def main():
    ...
    #source2 = '/home/luhongzhong/protein_sce_conservation_score/'
    #out_dir = '/home/luhongzhong/Documents/result_jsd/'
...
# example code
# python /home/luhongzhong/Documents/evolution_analysis/code/protein_conservation/step2_parse_jds_result.py -p0 /home/luhongzhong/protein_all_refine_align_sce/ -s /home/luhongzhong/protein_sce_conservation_score/ -o /home/luhongzhong/Documents/result_jsd/