...
def calConservationScore(fasta_file, jsd_file, outfile, output ="median"):
    '''
    ...
    index_sce = [i for i, x in enumerate(geneID) if "Saccharomyces_cerevisiae@" in x or "SACE_288c_" in x]
    if len(index_sce)>=1:
...
def main():
    ...
    # test code
    # source = '/media/luhongzhong/newdisk/Genomics_data/protein_align/'
    # source2 = '/media/luhongzhong/newdisk/Genomics_data/protein_sce_conservation_score/'
    # out_dir = '/media/luhongzhong/newdisk/Genomics_data/result_jsd/'
    ...
    for i in all_ID:
        ...
        score0 = calConservationScore(fasta_file=fasta_file0, jsd_file=jsd_file0, outfile=outfile0, output="median")
...
# example code
# python /home/luhongzhong/Documents/evolution_analysis/code/protein_conservation/step2_parse_jds_result_with_sce_as_reference.py -p0 /home/luhongzhong/protein_all_refine_align_sce/ -s /home/luhongzhong/protein_sce_conservation_score/ -o /home/luhongzhong/Documents/result_jsd/