    ...
    for record in SeqIO.parse(fasta_input, "fasta"):
        ...
        for index in range(0, len(record.seq), 3):
            ...
            if codon in codon_stop_array:
                print(record.id + "has stop codon. It will be removed!")
...
# python A5_remove_stop_codon_commond_line.py  -n /Users/luho/Documents/cds_all/ -o /Users/luho/Documents/cds_all0/
# python A5_remove_stop_codon_commond_line.py  -h