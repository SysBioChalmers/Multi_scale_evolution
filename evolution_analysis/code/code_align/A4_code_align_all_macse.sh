...
do
    java -jar /home/luhongzhong/Documents/evolution_analysis/code/code_align/macse.jar -prog reportGapsAA2NT -align_AA /home/luhongzhong/protein_all_refine_align/${i%_code.fasta}_aa_aligned.fasta  -seq $i -out_NT /home/luhongzhong/cds_all_refine_align/$i
done
