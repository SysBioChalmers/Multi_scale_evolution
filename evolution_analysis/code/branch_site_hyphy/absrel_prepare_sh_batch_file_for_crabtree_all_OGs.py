...
data_dir = "/Users/luho/Documents/branch_site_crabtree_all_OGs/cds_align_guidance_new/"
result_file = "/Users/luho/Documents/branch_site_crabtree_all_OGs/absrel_result/"
tree_dir ="/Users/luho/Documents/branch_site_crabtree_all_OGs/cds_align_guidance_new_tree_unroot_label/"
...
def produceaBSREL_cluster_parallel_lu(OG_list, out_sh_file, parallel=10):
    outfile = "/Users/luho/Documents/evolution_analysis/code/branch_site_hyphy/" + out_sh_file
...
all_file0 = [x for x, y in zip(all_file, seq_num) if y >= 0 and y < 20]
all_file1 = [x for x, y in zip(all_file, seq_num) if y >= 20 and y < 30]
all_file2 = [x for x, y in zip(all_file, seq_num) if y >= 30 and y < 50]
...
print(len(all_file0)) #18  0     0
print(len(all_file1)) #26  10    10  10 # can't be calculated!
print(len(all_file2)) #135  207   52  20 # can't be calculated!
...
# cluster-lu
#produceaBSREL_cluster_parallel_lu(OG_list=all_file0, out_sh_file="aBSREL_07-16_00.sh")
#produceaBSREL_cluster_parallel_lu(OG_list=all_file1, out_sh_file="aBSREL_07-16_01.sh", parallel=5)
produceaBSREL_cluster_parallel_lu(OG_list=all_file, out_sh_file="aBSREL_12-07_00.sh", parallel=5)

#produceaBSREL_cluster_parallel_lu(OG_list=all_file0, out_sh_file="aBSREL_09-20_00.sh", parallel=5)
#produceaBSREL_cluster_parallel_lu(OG_list=all_file1, out_sh_file="aBSREL_09-20_01.sh", parallel=5)
