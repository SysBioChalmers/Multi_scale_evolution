...
do
	python /c3se/users/luho/Hebbe/evolution_analysis/code/gene_dn_ds_paml/G1_produce_control_file.py -n /c3se/NOBACKUP/users/luho/cds_align/$i -c /c3se/users/luho/Hebbe/evolution_analysis/paml_model/yn00_model/ -o /c3se/NOBACKUP/users/luho/gene_dN_dS_result/${i%_code_align.phy}.out
