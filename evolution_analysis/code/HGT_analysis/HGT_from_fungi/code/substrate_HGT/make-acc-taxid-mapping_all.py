...
# Run command line: python make-acc-taxid-mapping_all.py accession_all.txt /Users/leyu/Downloads/prot.accession2taxid.gz
# failed to find 2331 acc, found 60500 of 62831 by NCBI downloaded database.
# found 2330 out of 2331 acc by Biopython.
...
def get_taxid_by_biopython() :
    ...
    # ['pir|T43149|']
    # Accession to taxid not found by Biopython: 1
    outfile.close()
