...
cd /home/luhongzhong/ortholog_343_methanol/cds_refine_filter
for i in *_code.fasta
    do
        perl /home/luhongzhong/Documents/guidance.v2.02/www/Guidance/guidance.pl --seqFile /home/luhongzhong/ortholog_343_methanol/cds_refine_filter/$i  --msaProgram MAFFT --seqType codon --outDir /home/luhongzhong/ortholog_343_methanol/cds_align_guidance/${i%_code.fasta}_result --genCode 1 --bootstraps 30 --proc_num 4 --seqCutoff 0.6 --colCutoff 0.93
        ...
        #perl /home/luhongzhong/ortholog_343_methanol/guidance.v2.02/www/Guidance/guidance.pl --seqFile /home/luhongzhong/ortholog_343_methanol/cds_refine_filter/OG10919_code.fasta  --msaProgram MAFFT --seqType codon --outDir /home/luhongzhong/ortholog_343_methanol/cds_align_guidance/OG10919_result --genCode 1 --bootstraps 30 --proc_num 4 --seqCutoff 0.6 --colCutoff 0.93
        #perl /home/luhongzhong/ortholog_343_methanol/guidance.v2.02/www/Guidance/guidance.pl --seqFile /home/luhongzhong/ortholog_343_methanol/cds_refine_filter/OG17103_code.fasta  --msaProgram MAFFT --seqType codon --outDir /home/luhongzhong/ortholog_343_methanol/cds_align_guidance/OG17103_result --genCode 1 --bootstraps 30 --proc_num 4 --seqCutoff 0.6 --colCutoff 0.93
        #perl /home/luhongzhong/ortholog_343_methanol/guidance.v2.02/www/Guidance/guidance.pl --seqFile /home/luhongzhong/ortholog_343_methanol/cds_refine_filter/OG1613_code.fasta  --msaProgram MAFFT --seqType codon --outDir /home/luhongzhong/ortholog_343_methanol/cds_align_guidance/OG1613_result --genCode 1 --bootstraps 30 --proc_num 4 --seqCutoff 0.6 --colCutoff 0.93
    done
    ''')
...
os.system("mkdir /home/luhongzhong/ortholog_343_methanol/cds_align_guidance_new")
os.system("python /home/luhongzhong/Documents/evolution_analysis/code/code_align/A9_move_align_guidance_into_new_file.py  -r /home/luhongzhong/ortholog_343_methanol/cds_align_guidance/ -n /home/luhongzhong/ortholog_343_methanol/cds_align_guidance_new/")
...
#---------------------------------
library(ape)
    tree_dir <- "/home/luhongzhong/ortholog_343_methanol/cds_align_guidance_new_tree"
...
with open("unroot_tree.sh", "w") as rsh:
    ...
    mkdir /home/luhongzhong/ortholog_343_methanol/cds_align_guidance_new_tree_unroot/
    cd /home/luhongzhong/ortholog_343_methanol/cds_align_guidance_new_tree
    for i in *_aa_unroot.tre
        do 
            mv $i /home/luhongzhong/ortholog_343_methanol/cds_align_guidance_new_tree_unroot/
        done
...
with open("absrel.sh", "w") as rsh:
    ...
    cd /home/luhongzhong/ortholog_343_methanol/cds_align_guidance_new_tree_unroot_label
    for i in *_aa_unroot_LABEL.tre
        do
            hyphy absrel --alignment /home/luhongzhong/ortholog_343_methanol/cds_align_guidance_new/${i%_aa_unroot_LABEL.tre}_code.fasta --tree /home/luhongzhong/ortholog_343_methanol/cds_align_guidance_new_tree_unroot_label/$i --branches Foreground --output /home/luhongzhong/ortholog_343_methanol/absrel_result/${i%_aa_unroot_LABEL.tre}.ABSREL.json
        done
    ''')
...
with open("busted.sh", "w") as rsh:
    ...
    for i in *_aa_unroot_LABEL.tre
        do
            hyphy busted --alignment /home/luhongzhong/ortholog_343_methanol/cds_align_guidance_new/${i%_aa_unroot_LABEL.tre}_code.fasta --tree /home/luhongzhong/ortholog_343_methanol/cds_align_guidance_new_tree_unroot_label/$i --branches Foreground --srv Yes --output /home/luhongzhong/ortholog_343_methanol/busted_result/${i%_aa_unroot_LABEL.tre}.BUSTED.json
        done
    ''')
