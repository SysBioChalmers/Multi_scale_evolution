...
with open("build_tree_step2.sh", "w") as rsh:
    rsh.write('''\
    #!/bin/bash
    mkdir /home/luhongzhong/ortholog_343_simplify/protein_align_tree_2
    cd /home/luhongzhong/ortholog_343_simplify/protein_align_s2_R/
        for i in *_aa_aligned.fasta
            do
                FastTree -lg < $i > /home/luhongzhong/ortholog_343_simplify/protein_align_tree_2/${i%_aa_aligned.fasta}_aa.tre
            done
    ''')
...
#---------------------------------
library(ape)
    tree_dir <- "/home/luhongzhong/ortholog_343_simplify/protein_align_tree_2"
...
with open("unroot_tree.sh", "w") as rsh:
    ...
    mkdir /home/luhongzhong/ortholog_343_simplify/unroot_tree/
    cd /home/luhongzhong/ortholog_343_simplify/protein_align_tree_2
    for i in *_aa_unroot.tre
        do 
            mv $i /home/luhongzhong/ortholog_343_simplify/unroot_tree/
        done
...
# tree name unify
os.system("mkdir /home/luhongzhong/ortholog_343_simplify/unroot_tree_unify/")
code_dir0 = "/home/luhongzhong/Documents/evolution_analysis/code/tree_build/"
cmd = "python" + " " + \
      code_dir0 + \
      "B4_unify_geneID_name.py -t /home/luhongzhong/ortholog_343_simplify/unroot_tree/ -id /home/luhongzhong/Documents/evolution_analysis/data/orthomcl_SeqIDs_index.txt -o /home/luhongzhong/ortholog_343_simplify/unroot_tree_unify/"
os.system(cmd)
...
cmd = "python" + " " + \
                  code_dir0 + \
                  "s5_collect_proteinID_high_quality.py -p0 /home/luhongzhong/ortholog_343/protein_align/ -p1 /home/luhongzhong/ortholog_343_simplify/protein_align_s2_R/ -o /home/luhongzhong/ortholog_343_simplify/protein_refine/ -t unprune"
os.system("mkdir /home/luhongzhong/ortholog_343_simplify/protein_refine/")
os.system(cmd)
...
mkdir /home/luhongzhong/ortholog_343_simplify/cds_align_macse/
cd /home/luhongzhong/ortholog_343_simplify/cds_refine/
for i in *_code.fasta
do
    java -jar /home/luhongzhong/Documents/evolution_analysis/code/code_align/macse.jar -prog reportGapsAA2NT -align_AA /home/luhongzhong/ortholog_343_simplify/protein_refine/${i%_code.fasta}_aa_aligned.fasta  -seq $i -out_NT /home/luhongzhong/ortholog_343_simplify/cds_align_macse/$i
done
    ''')
...
os.system("mkdir /home/luhongzhong/ortholog_343_simplify/cds_align_macse_remove_stop_code")
code_dir0 = "/home/luhongzhong/Documents/evolution_analysis/code/code_align/"
cmd = "python" + " " + \
                  code_dir0 + \
                  "A5_remove_stop_codon_commond_line.py  -n /home/luhongzhong/ortholog_343_simplify/cds_align_macse/ -o /home/luhongzhong/ortholog_343_simplify/cds_align_macse_remove_stop_code/"
os.system(cmd)
...
cmd = "python" + " " + \
                  code_dir0 + \
                  "A6_prepare_code_for_paml.py -n /home/luhongzhong/ortholog_343_simplify/cds_align_macse_remove_stop_code/ -id /home/luhongzhong/Documents/evolution_analysis/data/orthomcl_SeqIDs_index.txt -o /home/luhongzhong/ortholog_343_simplify/cds_align_unify/"
os.system(" mkdir /home/luhongzhong/ortholog_343_simplify/cds_align_unify/")
os.system(cmd)
...
with open("fubar.sh", "w") as rsh:
    rsh.write('''\
    #!/bin/bash
    mkdir /home/luhongzhong/ortholog_343_simplify/fubar_result/

    cd /home/luhongzhong/ortholog_343_simplify/cds_align_macse_remove_stop_code
    for i in *_code.fasta
        do
            hyphy fubar --alignment /home/luhongzhong/ortholog_343_simplify/cds_align_macse_remove_stop_code/$i --tree /home/luhongzhong/ortholog_343_simplify/unroot_tree/${i%_code.fasta}_aa_unroot.tre --output /home/luhongzhong/ortholog_343_simplify/fubar_result/${i%_code.fasta}_code.fasta.FUBAR.json
            rm /home/luhongzhong/ortholog_343_simplify/cds_align_macse_remove_stop_code/${i%_code.fasta}_code.fasta.FUBAR.cache
        done
    ''')
...
with open("Label_tree_hyphy.sh", "w") as rsh:
    rsh.write('''\
#!/bin/bash
mkdir /home/luhongzhong/ortholog_343_simplify/unroot_tree_label/
...
with open("absrel.sh", "w") as rsh:
    rsh.write('''\
    #!/bin/bash
    mkdir /home/luhongzhong/ortholog_343_simplify/absrel_result/
    cd /home/luhongzhong/ortholog_343_simplify/unroot_tree_label
    for i in *_aa_unroot_LABEL.tre
        do
            hyphy absrel --alignment /home/luhongzhong/ortholog_343_simplify/cds_align_macse_remove_stop_code/${i%_aa_unroot_LABEL.tre}_code.fasta --tree /home/luhongzhong/ortholog_343_simplify/unroot_tree_label/$i --branches Foreground --output /home/luhongzhong/ortholog_343_simplify/absrel_result/${i%_aa_unroot_LABEL.tre}.ABSREL.json
        done
    ''')
...
with open("busted.sh", "w") as rsh:
    rsh.write('''\
    #!/bin/bash
    mkdir /home/luhongzhong/ortholog_343_simplify/busted_result/
    cd /home/luhongzhong/ortholog_343_simplify/unroot_tree_label
    for i in *_aa_unroot_LABEL.tre
        do
            hyphy busted --alignment /home/luhongzhong/ortholog_343_simplify/cds_align_macse_remove_stop_code/${i%_aa_unroot_LABEL.tre}_code.fasta --tree /home/luhongzhong/ortholog_343_simplify/unroot_tree_label/$i --branches Foreground --srv Yes --output /home/luhongzhong/ortholog_343_simplify/busted_result/${i%_aa_unroot_LABEL.tre}.BUSTED.json
        done
    ''')
