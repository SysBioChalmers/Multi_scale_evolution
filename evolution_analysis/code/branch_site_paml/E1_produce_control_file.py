...
#ev_model = "/Users/luho/Documents/PAML/branch_site_model/"
...
def main():
    parser = argparse.ArgumentParser(
            ...
            description = 'Prepare the control for the branch_site model of PAML')
    #adding arguments
    ...
    prepareSiteFile(fast_input=cdsfile,tree_input=treefile,ev_model=codefile, result_out=resultfile)
if __name__ == "__main__":
    main()

# an example
# python B1_produce_control_file_in_batch.py -n /Users/luho/Documents/PAML/data/Example2.pml -t /Users/luho/Documents/PAML/data/Example2.tree -c /Users/luho/Documents/PAML/branch_site_model/ -o /Users/luho/Documents/paml_result/Example2_out
